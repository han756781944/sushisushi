<?php get_header();?>	
  ...
  <div id="wrapper">
    ...
    <div id="oshirase">
      <ol class="breadcrumbs"><li class="home"><a href="<?php bloginfo('home'); ?>">Home</a></li><li class="selected"><a href="<?php echo get_page_link(4);?>">Menu</a></li><li class="selected"><?php echo single_cat_title('', false );?></li></ol>  
